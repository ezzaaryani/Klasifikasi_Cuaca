...
# NAVBAR
tab1, tab2, tab3, tab4 = st.tabs(["🔍 Prediksi", "📊 Informasi", "💻 Source Code", "👩‍💻 About Me"])
...
with tab2:
    ...
    <p style="font-size:14px; line-height:1.7;">
        Model utama yang digunakan dalam aplikasi ini adalah <b>Random Forest Classifier</b>. 
    Algoritma ini dipilih karena mampu menghasilkan performa terbaik dengan tingkat akurasi yang tinggi dalam mengklasifikasikan berbagai kondisi cuaca berdasarkan parameter atmosfer dan lingkungan. 
    Dengan menggabungkan banyak Decision Tree, model dapat mengurangi risiko overfitting serta menghasilkan prediksi yang lebih stabil, konsisten, dan akurat pada data baru.
    </p>
    </div>
    """, unsafe_allow_html=True)
# SOURCE CODE TAB
